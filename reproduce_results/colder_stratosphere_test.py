...
description = """In this experiments we use a 175k stratosphere to see the effect
of colder stratospheric temperatures in our results""" 

# read input data
O2_flux = np.loadtxt('input_data/gregory_O2_flux.txt')
temp = eval(args.temp)
temp_profile, p0_list = get_temp(temp, cold_stratosphere=True)
...
# run experiment
nmodels=len(O2_flux)
NAME = f'colder_stratosphere_fratio={args.fratio}_temp={args.temp}_rh={args.rh}'
